...
typedef enum {
	...
	BOARD1_OUTPUT_SHAMPOO_GREEN_PUMP,		//香波泡沫计量泵（绿）
	BOARD1_OUTPUT_SHAMPOO_PINK_PUMP,		//香波泡沫计量泵（粉）
	BOARD1_OUTPUT_WAXWATER_PUMP,			//蜡水计量泵
	BOARD1_OUTPUT_CLEANER_VALVE,			//泥沙松动剂水阀
	BOARD1_OUTPUT_SHAMPOO_PINK_VALVE,		//香波水阀（粉）
	BOARD1_OUTPUT_CLEAR_WATER_VALVE,		//清水水阀
	BOARD1_OUTPUT_WAXWATER_VALVE,			//蜡水水阀
	BOARD1_OUTPUT_DRIER_VALVE,				//助干剂水阀
	BOARD1_OUTPUT_TOP_WATER_VALVE,			//顶刷水阀
	BOARD1_OUTPUT_FRONT_BRUSH_WATER_VALVE,	//前刷水阀
	BOARD1_OUTPUT_BACK_BRUSH_WATER_VALVE,	//后刷水阀
	BOARD1_OUTPUT_BASE_PLATE_WASH_VALVE,	//底盘冲洗阀
	BOARD1_OUTPUT_SHAMPOO_WATER_VALVE,		//香波水阀（蓝）
	BOARD1_OUTPUT_SHAMPOO_GREEN_VALVE,		//香波水阀（绿）
	BOARD1_OUTPUT_DRAIN_WATER_VALVE,		//排水气阀
	...
	BOARD4_OUTPUT_LEFT_BOARD_CLEAN_VALVE,	//左地板冲洗阀====
	BOARD4_OUTPUT_LRIGHT_BOARD_CLEAN_VALVE,	//右地板冲洗阀====
	BOARD4_OUTPUT_SWING_VALVE,				//摆动喷淋阀====
	BOARD4_OUTPUT_PIN_NUM,
	//5号IO扩展板
	BOARD5_OUTPUT_TOP_ROTATION_CWW = 6*DIFF_BOARD_IO_VALUE,	//顶刷旋转（反转预留）
	BOARD5_OUTPUT_TOP_ROTATION_RESET,		//顶刷旋转变频器复位
	BOARD5_OUTPUT_TOP_SWING_CWW,			//顶部喷淋摆动（反转预留）
	BOARD5_OUTPUT_TOP_SWING_RESET,			//顶部喷淋摆动变频器复位
	BOARD5_OUTPUT_RESERVE_1,
	BOARD5_OUTPUT_RESERVE_2,
	BOARD5_OUTPUT_RESERVE_3,
	BOARD5_OUTPUT_RESERVE_4,
