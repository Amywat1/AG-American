...
typedef enum {
	...
	BOARD0_OUTPUT_SHAMPOO_NORMAL_AIR_VALVE,	//香波气阀
	...
	BOARD1_OUTPUT_SHAMPOO_PREMIUM_PUMP,		//香波泡沫计量泵（高级的）
	BOARD1_OUTPUT_SHAMPOO_NORMAL_PUMP,		//香波泡沫计量泵（普通的）
	BOARD1_OUTPUT_WAX_PUMP,					//镀膜计量泵
	BOARD1_OUTPUT_WAXWATER_PUMP,			//蜡水计量泵
	BOARD1_OUTPUT_CLEANER_VALVE,			//泥沙松动剂水阀
	BOARD1_OUTPUT_WAX_VALVE,				//镀膜水阀
	...
	BOARD1_OUTPUT_SHAMPOO_NORMAL_VALVE,		//香波水阀（普通的）
	BOARD1_OUTPUT_SHAMPOO_PREMIUM_VALVE,	//香波水阀（高级的）
	BOARD0_OUTPUT_SHAMPOO_PREMIUM_AIR_VALVE,//高级香波气阀
