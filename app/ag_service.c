...
static Type_AppCmdMap_Def AppCmdMap_Table[] = {
   ...
   {CMD_WATER_CLEAR,            APP_CRL_WATER_CLEAR,            &appModule.localCmd.clearWater,         "cmd_water_clear_water"},
   {CMD_WATER_COATING_FILM,     APP_CRL_WATER_COATING_FILM,     &appModule.localCmd.coatingFilmWater,   "cmd_water_coating_film"},
   {CMD_WATER_BASE_PLATE,       APP_CRL_WATER_BASE_PLATE,       &appModule.localCmd.basePlateWater,     "cmd_water_base_plate"},
   {CMD_WATER_PREMIUM_SHAMPOO,  APP_CRL_WATER_PREMIUM_SHAMPOO,  &appModule.localCmd.premiumShampoo,     "cmd_water_premium_shampoo"},
